...
❖${prefix}** clear ** ==>**لمسح كل  100 رساله **
❖${prefix}** role ** ==>**لاعطاء رتبه للشخص**
❖${prefix}** roleall ** ==>**لاعطاء رتبه للجميع**
❖${prefix}** ccolors ** ==>** لانشاء الوان **
❖${prefix}** bc ** ==>** للبرودكستات **
      __**الاوامر العامة :coffee:**__
❖${prefix}** credit ** ==>**لمعرفة رصيدك**
❖${prefix}** move ** ==>** لسحب شخص لرومك **
❖${prefix}** tag ** ==>** لكتابة الي انت تكتبه بي طريقة جميله **
❖${prefix}** allbots ** ==>** لمشاهدة جميع البوتات الي فلسيرفر **
❖${prefix}** bot ** ==>** لمشاهدة اشياء عن البوت**
❖${prefix}** server ** ==>** لمشاهدة اشياء عن السيرفر**
❖${prefix}** inv ** ==>** لدعوة البوت الي سيرفرك**
❖${prefix}** short ** ==>** لمشاهدة جميع البوتات الي فلسيرفر **

      __**الاوامر الترفيهية :coffee:**__
❖${prefix}** مريم ** ==>**للعب مع مريم**
❖${prefix}**  fkk** ==>**لكي يعطيك جمل كت تويت عشوائية**
❖${prefix}** quas ** ==>**اسئله عامه **
❖${prefix}**  عواصم** ==>**لي لعبة عواصم**
❖${prefix}** عقاب ** ==>** لمشاهدة جميع البوتات الي فلسيرفر **
❖${prefix}** short ** ==>** لاختصار الروابط**
❖${prefix}** هل تعلم ** ==>**  لي لعبة هل تعلم**
